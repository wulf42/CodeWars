...
namespace CodeWars
{
    public static class Kata
    {
        ...
        public static int[] SortArray(int[] array)    //even(2,4,6...) stay, sort odd (1,3,5...)           //bubble sort implemented
        {
        ...
        public static int SquareDigits(int n)
        {
            ...
            {
                result += Math.Pow(int.Parse(c.ToString()), 2);
            }
        ...
        public static string Likes(string[] name)
        {
            ...
            {
                0 => "no one likes this",
                1 => string.Format("{0} likes this", name[0]),
                2 => string.Format("{0} and {1} like this", name[0], name[1]),
                3 => string.Format("{0}, {1} and {2} like this", name[0], name[1], name[2]),
        ...
        public static int? chooseBestSum(int t, int k, List<int> ls) //fajne zadanie do zrobienia
        {
            //wywołanie
            //List<int> distances = new List<int> { 50, 55, 57, 58, 60 };
            //Console.WriteLine(Kata.chooseBestSum(174, 3, distances));
